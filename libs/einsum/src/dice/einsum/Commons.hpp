...
namespace dice::einsum {
	...
	namespace detail {
		...
		constexpr auto inject_value_type(Hypertrie_t<key_part_type_o, value_type_o, map_type_o, set_type_o, taggable_key_part_v>) {
			return Hypertrie_t<key_part_type_o, new_value_type, map_type_o, set_type_o, taggable_key_part_v>{};
		}
	}// namespace detail
