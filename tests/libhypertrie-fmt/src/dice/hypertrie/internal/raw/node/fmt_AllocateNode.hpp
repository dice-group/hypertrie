...
namespace fmt {
	...
	struct formatter<::dice::hypertrie::internal::raw::AllocateNode<node_type_t, depth, htt_t, allocator_type>> : ::dice::hypertrie::internal::util::SimpleParsing {
		template<typename T>
		static auto nameOfType() {
			return ::dice::hypertrie::internal::util::name_of_type<T>();
		}
		template<typename FormatContext>
		auto format(::dice::hypertrie::internal::raw::AllocateNode<node_type_t, depth, htt_t, allocator_type> const &, FormatContext &ctx) {
