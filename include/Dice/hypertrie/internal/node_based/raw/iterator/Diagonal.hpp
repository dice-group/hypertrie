...
namespace hypertrie::internal::node_based::raw {
		...
		template<pos_type diag_depth, pos_type depth, HypertrieInternalTrait tri_t>
	class HashDiagonal {
		using tri = tri_t;
	...
	public:
		explicit RawHashDiagonal(const RawBoolHypertrie_t<depth> &boolhypertrie) : rawboolhypertrie{boolhypertrie} {}
	...
	class RawHashDiagonal<diag_depth, depth, key_part_type, map_type, set_type, std::enable_if_t<(depth > diag_depth and depth > 1)>> {
