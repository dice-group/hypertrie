...
namespace hypertrie {
	...
	using Hypertrie_trait = internal::Hypertrie_t<key_part_type_t, value_type_t, Allocator, map_type_t, set_type_t, lsb_unused_v>;
	...
	using lsbunused_bool_Hypertrie_trait = Hypertrie_trait<unsigned long,
												   bool,
												   std::allocator<std::byte>,
												   hypertrie::internal::container::tsl_sparse_map,
												   hypertrie::internal::container::tsl_sparse_set,
